...
import './sign_in.dart'; // Import your main screen
        ...
        body: Container(
          ...
          child: Column(
            ...
            child: Container(
              ...
              boxShadow: [
                BoxShadow(
                  color: Color.fromARGB(255, 218, 218, 218).withOpacity(0.2), // Shadow color
            ...
            child: TextButton(
                  ...
                  style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all<Color>(Color.fromRGBO(172, 194, 112, 1)),
