                          ...
                          child: Column(
                            children: [
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          ...
                                          child: Text(
                                            'Send & Receive Live Messages From Vendors & Clients',
                                            style: TextStyle(
                                                color: Color.fromRGBO(
                                                    107, 123, 66, 1),
                                                fontSize: 23,
                              ...
                              Padding(
                                  ...
                                  child: Text(
                                    'You can have live conversations with the chat function built into the app, this feature helps mutual communication between vendors and clients possible',
                                    style: TextStyle(
                              ...
                              Padding(
                                  padding: EdgeInsets.fromLTRB(15, 15, 15, 15),
                                  child: Text(
                                    'All features necessary for effective communication has been included for this purpose...',
                                    style: TextStyle(
                                        color: Color.fromRGBO(153, 153, 153, 1),
                                        fontSize: 16,
                                        fontWeight: FontWeight.w400),
