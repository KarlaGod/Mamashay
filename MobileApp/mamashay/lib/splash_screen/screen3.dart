                          ...
                          child: Column(
                            children: [
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          ...
                                          child: Text(
                                            'Pin Unlimited Items & Products To Favourites',
                                            style: TextStyle(
                                                color: Color.fromRGBO(
                                                    107, 123, 66, 1),
                                                fontSize: 23,
                              ...
                              Padding(
                                  ...
                                  child: Text(
                                    'You can can pin an unlimited number of your favourite items or vendors on the homescreen so that when next you launch the app, you have them at finger tips.',
                                    style: TextStyle(
                              ...
                              Padding(
                                  padding: EdgeInsets.fromLTRB(15, 15, 15, 15),
                                  child: Text(
                                    'This gives you much quicker access to vendors & items on the app...',
                                    style: TextStyle(
                                        color: Color.fromRGBO(153, 153, 153, 1),
                                        fontSize: 16,
                                        fontWeight: FontWeight.w400),
