            ...
            return(
                <div className='w-screen h-screen' key={index}>
                    ...
                    <div className='bg-fborder absolute bottom-0 pt-4 pb-6 px-3 gap-2 flex items-center w-screen justify-between'>
                        <div className='flex bg-secondary p-1 rounded-full w-full'>
                            <button><Image src={c.add_doc} alt='...' width={15} height={15} /></button>
                            <input type="text" placeholder='Type message here' />
                            <Image src={c.placeholderimg} alt='...' width={15} height={15} />
                        </div>
