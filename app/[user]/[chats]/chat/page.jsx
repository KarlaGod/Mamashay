        ...
        chat.map((c, index) => {
            return(
                <div className='w-screen h-screen flex flex-col' key={index}>
                    {/* Header of the Page */}
                    <header className='grid fixed px-3 z-10 bg-fborder'>
                    ...
                    <div className='overflow-y-scroll bottom-0 bg-tertiary pt-60 mx-4'>
                    ...
                    <div className='bg-fborder fixed bottom-0 pt-4 pb-6 px-3 z-10 gap-2 flex items-center w-screen justify-between'>
